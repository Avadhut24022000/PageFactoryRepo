...
public static ExtentReports getInstance() {
		...
		report.addSystemInfo("Selenium Version", "4.1.1").addSystemInfo(
				"Environment", "QA").addSystemInfo("Tester Name", "Avadhut Suryavanshi").
		addSystemInfo("Company", "Cognizant Technology Solutions");
